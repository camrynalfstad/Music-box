...
# How to wire
-Place the four tactile buttons with each set of prong on either side of the middle of the breadboard
-Connect one set of prongs on each tactile button to Ground
-Connect the other set of prong on button 1 to pin 22
